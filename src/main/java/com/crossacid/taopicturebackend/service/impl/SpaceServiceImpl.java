...
import com.crossacid.taopicturebackend.mapper.SpaceMapper;
...
import com.crossacid.taopicturebackend.model.enums.SpaceLevelEnum;
        ...
        synchronized (lock) {
            Long newSpaceId = transactionTemplate.execute(status -> {
                boolean exists = this.lambdaQuery()
                        ...
                        .exists();
                ThrowUtils.throwIf(exists, ErrorCode.OPERATION_ERROR, "每个用户每类仅能有一个空间");
                // 写入数据库
                // 写入数据库
